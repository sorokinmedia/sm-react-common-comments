...
function LoadingButton(props) {
	...
	return React$$1.createElement(
		...
		loading ? React$$1.createElement(InlineAbsolutePositionLoader, { color: '#ffffff', left: '30%' }) : props.children
	);
}
...
var dist_5 = dist$1.LoadingButton;
...
var MessagesForm = function (_Component) {
	...
	function MessagesForm(props) {
		...
		_this.handleChange = function (ev) {
			var string = ev.replace(/href="(.*?)"/, function (m, $1) {
				var link = $1.replace(/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)/, '');
				return 'href="http://' + link + '" target="_blank" rel="nofollow noopener"';
			});

			_this.props.onChangeForm(string);
